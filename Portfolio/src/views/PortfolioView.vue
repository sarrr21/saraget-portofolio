        ...
        <div v-for="item in items" :key="item.id">
          <div class="item-card flex flex-col items-center gap-2 rounded bg-[#1e1e1f] hover:bg-[#282828] border border-[#383838] rounded-xl text-amber-50 md:gap-3 px-5 py-5 lg:px-5">
            <div class="flex h-12 w-12 items-center justify-center p-0 h-full w-full lg:p-0 zoom-in">
              <img alt="Project Image" loading="lazy" decoding="async" :src="'/img/portfolio-' + item.imageUrl + '.png'">
            </div>
            <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
              ...
              <div class="w-full flex justify-end">
                <div class="flex cursor-pointer items-end gap-2 text-primary">
                  <a v-if="item.github" :href="item.github" target="_blank" rel="noreferrer" title="View GitHub repository" class="transition-all hover:text-accent">
    ...
    return {
      items: [
        ...
        },
        {
          ...
          name: 'LOGISTICA',
          imageUrl: 'ss1',
          status: 'We specialize in crafting compelling digital experiences that elevate brands. From sleek design to seamless functionality, our websites are tailored to captivate audiences and drive engagement. Explore how we can transform your online presence and elevate your brand\'s story with our creative and effective web solutions',
          tech: 'React Js, Tailwind',
          github: null,
          demo: null
        },
