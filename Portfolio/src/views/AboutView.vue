    ...
    return {
      ...
      tech: [
        ...
        },
        {
          ...
          name: "Next-Js",
          imageUrl:
            "https://cdn.icon-icons.com/icons2/2415/PNG/512/next-js_original_logo_icon_146455.png",
          status: "Advance",
        },
      ...
      >
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Sara Getnet. I'm a Full
            Stack developer from Earth. I have 2+ year of experience in  web development.
             I really enjoy what I do rightnow, in my opinion, creating programs is not just a job, 
             but also an art that has aesthetic value
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My job is to build your idea to be functional
            and user-friendly yet still attractive. In addition, I provide a
            personal touch to your product and ensure that the product catches
            attention and is easy to use. My goal is to convey your message and
            identity in the most creative way. If you are interested in hiring
            me, please contact the listed contact.
          </p>
        </div>
      </section>
    </article>
