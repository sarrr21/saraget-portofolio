    ...
    >
      <div class="container mx-auto flex flex-wrap items-center justify-around">
        ...
        <div class="flex md:order-2 fadein-bot">
          <div class="flex px-6 md:order-2 fadein-bot">
            <a href="https://www.linkedin.com/in/sara-getnet" target="_blank"
              ><img
          ...
          <div class="flex px-6 md:order-2 fadein-bot">
            <a href="mailto:gs9425188@gmail.com" target="_blank"
              ><img
                class="w-9 rounded-full"
          ...
          <div class="flex px-6 md:order-2 fadein-bot">
            <a href="https://github.com/sarrr21" target="_blank"
              ><img
                class="w-9 rounded-full"
          ...
          <div class="flex px-6 md:order-2 fadein-bot">
            <a href="https://t.me/saracoder" target="_blank"
              ><img
                class="w-9 rounded-full"
